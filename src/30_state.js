...
let st = 'title', t = 0, P = {}, en = [], bu = [], pu = [], goo = [], fx = [], sat = [], fh = [], camX = 0, camY = 0,
    ...
    opts = [], sel = 0, best = [0, 0, 0], shake = 0, msg = '', msgT = 0, dead = 0, stT = 0, bolts = [], rails = [], eid = 0, eb = [], we = [], combo = 0, comboT = 0, bestC = 0, frz = 0, rush = 0, hstop = 0, tm = 0, flash = 0,
...
try { best = [0, 1, 2].map(i => +localStorage['OOO_best' + i] || 0); ach = +localStorage.OOO_ach || 0; } catch (e) {}
function newGame() {
