...
let st = 'title', t = 0, P = {}, en = [], bu = [], pu = [], goo = [], fx = [], sat = [], fh = [], camX = 0, camY = 0,
    ...
    opts = [], sel = 0, best = 0, shake = 0, msg = '', msgT = 0, dead = 0, stT = 0, bolts = [], eid = 0, eb = [], we = [], combo = 0, comboT = 0, bestC = 0, frz = 0, rush = 0, hstop = 0, tm = 0, flash = 0,
...
try { best = +localStorage.pl || 0; ach = +localStorage.ach || 0; } catch (e) {}
function newGame() {
  P = { x: WW / 2, y: WH / 2, an: 0, hp: 100, mhp: 100, spd: 1.45, rate: 1, extra: 0, dmg: 1, life: 1, luck: 1, bloom: 0, pierce: 0,
        inv: 0, t: 0, fo: [], c: {}, dx: 1, dy: 0 };
  camX = P.x - W / 2; camY = P.y - H / 2;
  en = []; bu = []; pu = []; goo = []; fx = []; bolts = []; eb = []; we = []; combo = comboT = bestC = frz = rush = hstop = tm = flash = bl = shards = mech = bossK = 0; bc = 3; puT = hT = -9e9;
